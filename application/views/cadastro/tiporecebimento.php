            ...
            <div class="modal-body">
                ...
                <div class="pre-scrollable">
                    <table class="table table-responsive table-bordered ">
                        ...
                        <tbody id="tbodyTiporecebimento" class="searchable">
                        <?php
                        if($tiporecebimento){

                            foreach($tiporecebimento as $recebimento):
                                ?>
                                <tr id="<?= $recebimento["tiporecebimento_descricao"] ?>">
                                    <td><?= $recebimento["tiporecebimento_descricao"] ?></td>
                                    <td>R$ <?= number_format($recebimento["tiporecebimento_valor"],2,",",".") ?></td>
                                    <td class="col-md-2 btn-primary" style="text-align: center"><button type="button" class="btn btn-primary" onclick="listUnique('<?=$this->encrypt->encode($recebimento["tiporecebimento_id"]) ?>')"><i class="glyphicon glyphicon-wrench"></i> Editar</button> </td>
                                </tr>
                                <?php
                            endforeach;
...
<div class="container">
    ...
    <div class="page-header">
        ...
        <div class="page-title">
            <h3>Cadastro de Tipo de Recebimento</h3>
        </div>
    </div>


    <form action="" method="post" enctype="multipart/form-data" id="formTipoRecebimento" role="form">
...
<script src="<?= base_url("js/projeto/cadastro/tiporecebimento.js") ?>"></script>